...
public class BankUtil {  
    public static void main(String[] args) {
        String cardNumber = "6227002670260063319";//卡号
    ...
    "623251", "628351","622568","520152","520382","911121","548844","622155" };  


    //"发卡行.卡种名称",   
    private static final String[] bankName1 = {
     ...
     "玉溪市商业银行·红塔卡","广发银行·新理财通借记卡","广发银行·南航明珠卡MC金卡","广发银行·南航明珠卡MC普卡","广发银行·理财通借记卡","广发银行·真情卡","平安银行信用卡" };  
