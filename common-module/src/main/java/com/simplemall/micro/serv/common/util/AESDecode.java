...
public class AESDecode {
    ...
    public static void main(String[] args) throws Exception {
        // 发送POST请求示例
 /*       String ak_id = "LTAIzazFWcVLtr8A"; //用户ak
        String ak_secret = "0CCTHBeZkW80KP6p5v7rPrMkXXQ9pq"; // 用户ak_secret
        String url = "https://dtplus-cn-shanghai.data.aliyuncs.com/face/verify";
        Map map = new HashMap();
        map.put("type",0);
        map.put("image_url_1","http://video.51btceth.com/1.jpg");
        map.put("image_url_2","http://video.51btceth.com/2.jpg");
...
/*        String ak_id1 = "NMV.............5jv"; //用户ak
        ...
        // 发送POST请求示例
        String ak_id2 = "LTAIzazFWcVLtr8A"; //用户ak
        String ak_secret2 = "0CCTHBeZkW80KP6p5v7rPrMkXXQ9pq"; // 用户ak_secret
        String url2 = "https://dtplus-cn-shanghai.data.aliyuncs.com/face/attribute";
        Map map2 = new HashMap();
        map2.put("type",0);
        map2.put("image_url","http://video.51btceth.com/1.jpg");
        String body2 = JSON.toJSONString(map2);
        System.out.println("response body:" + sendPost(url2, body2, ak_id2, ak_secret2));
    }
}