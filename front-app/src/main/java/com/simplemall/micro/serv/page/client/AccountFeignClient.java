...
public interface AccountFeignClient {
	 ...
	 * @return
	 */
	@RequestMapping("/acc/getAccount")
	public Account selectByPhone(@RequestParam("phone") String phone);
	/**
	 * 得到账户信息
	 *
	 * @param userId
	 ...
	 * @return
	 */
	@RequestMapping(value = "/acc/improveMessage")
	...
	public PageInfo<Map<Object,Object>> getAccList(@RequestBody Message message, @RequestParam("currentPage") Integer currentPage, @RequestParam("pageSize") Integer pageSize);
	/**
	 * 获取用户详情
	 * @return
	 */
	@RequestMapping(value = "/acc/detail")
	Map<Object,Object>  getAccDetail(@RequestParam("tid") String tid);
	/**
	 * get address list
	 * 
	 * @param accountTid
